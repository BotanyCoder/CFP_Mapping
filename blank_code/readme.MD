...
#Import data
#### ==> REPLACE FILE NAME <==
Example <- read.csv("SpeciesData.csv")
head(Example)
...
# IMPORTANT: make sure the output make sense and is properly named
...
## Step 3: Copy, paste, and save in a new file the code above.
